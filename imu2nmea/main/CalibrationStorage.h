...
static const float ANGLE_CAL_SCALE = 0.001f;
...
public:
    ...
    static void UpdateHeadingCalibration(int16_t angleCorr, bool isRelative = false);
    static void UpdatePitchCalibration(int16_t angleCorr, bool isRelative = false);
    static void UpdateRollCalibration(int16_t angleCorr, bool isRelative = false);
private:
    ...
    static void updateAngleCorrection(const char *key, int16_t angleCorr, bool isRelative);
};
